...
# Evita caché innecesario, lo que mantiene la imagen ligera.
# Es especialmente útil cuando se utilizan imágenes basadas en Alpine Linux, como node:18-alpine3.15.
# Basicamente la imagen deps instala las dependencias necesarias asegurándose de reinstalar unicamente las dependencias que cambiaron
